...
image::resources/TP/Qt01.png[alt="Une simple fenêtre créée avec QApplication et comportant un QPushButton. Appelez QPushButton.show() pour afficher le bouton."]
...
image::resources/TP/Qt02.png[alt="Utilisez setToolTip(QString) pour une infobulle."]
...
image::resources/TP/Qt03.png[alt="Utilisez setFont(QFont) pour changer la police utilisée."]
...
image::resources/TP/Qt04.png[alt="Utilisez setIcon(QIcon) pour rajouter une icône."]

L'image que j'ai utilisé est celle-ci image:resources/TP/nyancat.png[title="nyan nyan nyan nyan", alt="Image à afficher sur le bouton."], mais vous pouvez bien évidemment en utiliser une autre.
...
image::resources/TP/Qt05.png[alt="Une fois votre fenêtre créée, vous pouvez par exemple la redimensionner avec setFixedSize(w,h), ou changer son titre avec setWindowTitle(title)."]
...
image::resources/TP/Qt07.png[alt="Les boîtes de dialogue simples n'ont pas besoin d'être implémentées à la main : QMessageBox fournit plusieurs méthodes statiques dédiées à cet usage. Ces boîtes de dialogues sont même capable d'afficher du texte enrichi par des balises HTML."]
...
image::resources/TP/Qt08.png[alt="Boîte de dialogue de type QMessageBox::question. Attention à la langue des boutons, qui doit être cohérente avec celle du texte affiché !"]
...
image::resources/TP/Qt10-1.png[alt="QInputDialog::getText"]
image::resources/TP/Qt10-2.png[alt="QInputDialog::getInteger"]
image::resources/TP/Qt10-3.png[alt="QInputDialog::getItem"]
...
image:resources/TP/Qt12-1.png[alt="Utilisation de QHBoxLayout pour positionner plusieurs boutons horizontalement."]
image:resources/TP/Qt12-2.png[alt="Utilisation de QVBoxLayout pour positionner plusieurs boutons verticalement."]
image:resources/TP/Qt12-3.png[alt="Utilisation de QGridLayout pour positionner plusieurs boutons au sein d'une grille."]
...
image::resources/TP/Qt13.png[alt="La zone centrale est un unique QWidget, ajouté à votre fenêtre grâce à QMainWindow.setCentralWidget ; les éléments de la zone centrale sont ensuite ajoutés à ce QWidget de la manière habituelle."]
...
image:resources/TP/Qt14-1.png[alt="Dans la barre d'outils, un QMenu « Fichier », avec trois éléments QAction : « Ouvrir... », « Enregistrer sous... », et « Quitter »."]
image:resources/TP/Qt14-2.png[alt="Dans la même barre d'outils, un QMenu « Aide », avec trois éléments QAction : « Aide en ligne », et « À propos »."]
...
image:resources/TP/Qt15.png[alt="Créez votre toolbar avec QMainWindow.addToolBar, puis ajoutez-lui vos QActions déjà créées grâce à QToolBar.addAction !"]
...
image:resources/TP/Qt16.png[alt="Créez cette fois une QMdiArea, que vous passerez en argument à setCentralWidget. Ajoutez-lui un nombre indéfini de QMdiSubWindow avec QMdiArea.addSubWindow. Récupérez la QMdiSubWindow active avec QMdiArea.activeSubWindow."]
...
image::resources/TP/Qt17-1.png[alt="Une QMainWindow affichant le sujet du présent TP dans une QWebView."]
image::resources/TP/Qt17-2.png[alt="Une QMainWindow affichant la page d'accueil de l'unistra dans une QWebView."]
