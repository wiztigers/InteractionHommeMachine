...
image::resources/illusion_akiyoshi9.png[caption="Exemple d'illusion d'optique :", title="© Akiyoshi Kitaoka, « Trick eyes ».", link=http://ophtasurf.free.fr/illusions_extraordinaires2.htm]

image::resources/triangle_de_curry.jpg[caption="Exemple d'illusion mathématique :", title="Triangle de Curry"]
...
image::resources/panda_cubs_inchengdu.png[caption="Votre vision active vous permet de détecter ces pandas dans leur milieu naturel ", title="(Panda cubs in Chengdu, inchengdu, CC BY 2.0)", link=https://www.flickr.com/photos/inchengdu/13665855435]
...
image::resources/ThéorieDeLAction.png[caption="Théorie de l'action ", title="(Don Norman, 1986)"]
