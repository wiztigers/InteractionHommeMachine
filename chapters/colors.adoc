...
Différents éléments de même nature peuvent être facilement identifiés par la rétutilisation du même code couleur.
...
Une palette de couleurs sera non seulement perçue différemment, mais devra souvent être affichée différemment selon la personne (daltonisme, ...) et selon le matériel (type & réglage de l'écran) considéré.
